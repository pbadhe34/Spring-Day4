...
public class Spring_RestTemplate_Client {

	public static final String SERVER_URI = "http://localhost:8080/Spring4-REST-Service/rest/person/";
	...
	private static void testGetPerson() {
		RestTemplate restTemplate = new RestTemplate();
		Person emp = restTemplate.getForObject(SERVER_URI+"get/7", Person.class);
		System.out.println("The person returned is  "+emp.getName());
	}
	...
	private static void testDeletePerson() {
		RestTemplate restTemplate = new RestTemplate();
		int id = 3;
		restTemplate.delete(SERVER_URI+"remove/"+id);
